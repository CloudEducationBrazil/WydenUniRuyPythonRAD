...
# https://github.com/MerciaMarques/CRUD?classId=27bd03ab-65b6-4263-90af-50d093a0956a&assignmentId=13d15b99-4d64-423e-8899-741ed1d1f38b&submissionId=3f84020e-dda1-3608-2d03-ad5fa9f578d2
...
while True:
    ...
    if (opcao == '1'):  # Primeiro cadastro
        ...
        if (escolha == '1'):
            nome = input("Digite o nome: ")
            # contador para buscar o indice dentro da lista nomes
            ...
            # Alterar dentro do Visualização do cadastro
            if (alterar_deletar == 'A' or alterar_deletar == 'a'):
                while (escolha != '0'):
                    escolha = input(
                        "O que desejar alterar \n1 - Nome, \n2 - Idade,\n3 - Telefone\n4 - Convênio \n5 - Sair \n__= ")
                    if (escolha == '1'):
                        nomes.insert(indice, input("Digite o novo nome: "))
                    elif (escolha == '2'):
                        idades.insert(indice, input("Digite a nova idade: "))
                    elif (escolha == '3'):
                        telefones.insert(indice, input(
            ...
            # Deletar dentro da visualizacao do cadastro
            elif (alterar_deletar == 'D' or alterar_deletar == 'd'):
                ...
                while (deletar != '0'):
                    if (deletar == '1'):
                        escolha = input(
                            "Tem certeza que deseja apagar todos os dados do cliente \n sim \n não \n__:")
                        if (escolha == 's'):
                            nomes[indice] = ' '
                            idades[indice] = ' '
                            telefones[indice] = ' '
            ...
            if registro in registros:
                ...
                # Fazer alteração ou deletar dentro da visualização da chave
                print("A - Deseja alterar o cadastro?")
                print("D - Deseja deletar o cadastro?")
                print("R - Retornar ao Menu Principal?")
                alterar_deletar = input("Digite a opção: ")
        ...
        while (deletar != '0'):
            if (deletar == '1'):
                ...
                escolha = input(
                    "Tem certeza que deseja apagar os dados do cliente \n's' sim \n'n' não \n__:")
                if (escolha == 's'):
                    nomes[indice] = ' '
                    idades[indice] = ' '
                    telefones[indice] = ' '
