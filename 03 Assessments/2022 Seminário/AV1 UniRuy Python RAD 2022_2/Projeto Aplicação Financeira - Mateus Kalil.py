...
while (True):
        ...
        if (coud == 1):
            while (True):
                ...
                if confime =='s':
                    ...
                    print('O valor necessário para pagar daqui a {} meses com {}% de taxa de juros será {:.2f}R$'.format(t, i, valorf))
        ...
        #descapitalização
            ...
            if confime =='s':
                ...
                print('O valor necessário para pagar daqui a {} meses sobre {}% de taxa de juros será {:.2f}R$ '.format(t, i, valorp))
